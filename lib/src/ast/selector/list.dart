...
class SelectorList extends Selector {
  ...
  factory SelectorList.parse(String contents, Logger logger, {url, bool allowParent: true}) =>
      new SelectorParser(contents, logger, url: url, allowParent: allowParent).parse();
